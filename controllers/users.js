...
export const getUsers = (req, res)=>{
  ...
  const q = "SELECT users.id,users.profilePic,users.name FROM users JOIN relationships ON(users.id NOT IN (SELECT relationships.followerUserId FROM relationships)) WHERE users.id <> ?";
