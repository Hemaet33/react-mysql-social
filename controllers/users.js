...
export const getUsers = (req, res)=>{
  ...
  const q = "SELECT users.id,users.profilePic,users.name FROM users INNER JOIN relationships ON(users.id <> relationships.followerUserId AND users.id <> ?) WHERE users.id=?";
