...
export const getUsers = (req, res)=>{
  ...
  const q = "SELECT users.id,users.profilePic,users.name FROM users JOIN relationships ON(users.id NOT IN (SELECT relationships.followedUserId FROM relationships)) WHERE relationships.followerUserId NOT IN (SELECT users.id FROM users WHERE users.id=?)";
