...
export const getUsers = (req, res)=>{
  ...
  const q = "SELECT users.id, users.profilePic, users.name FROM users WHERE users.id <> ? AND users.id NOT IN (SELECT users.id FROM users JOIN relationships ON(users.id = relationships.followedUserId) WHERE relationships.followerUserId=?)";
